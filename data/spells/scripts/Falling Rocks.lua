function onCastSpell(cid, var)
	...
	local function doFall(cid)
		for rocks = 1, 62 do
		    addEvent(fall, rocks*35, cid:getId(), master:getId(), ROCKDAMAGE, effD, eff)
		end
	end
	...
	addEvent(doDanoWithProtect, 1400, cid:getId(), ROCKDAMAGE, getThingPosWithDebug(cid:getId()), waterarea, -min, -max, 0)
