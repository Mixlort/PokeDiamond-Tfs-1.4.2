function onCastSpell(cid, var)
	...
	for a = 0, 3 do
		...
		addEvent(sendAtk, 300*a, cid:getId(), t[d][2])
		addEvent(doDanoWithProtect, 400*a, cid:getId(), DRAGONDAMAGE, t[d][2], pulse2, 0, 0, 177)
		addEvent(doDanoWithProtect, 400*a, cid:getId(), DRAGONDAMAGE, t[d][2], pulse1, 0, 0, t[d][1])
	end
