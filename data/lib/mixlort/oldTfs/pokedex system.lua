...
function doAddPokemonInDexList(cid, poke)
    ...
    cid:setStorageStringValue(a.storage, b.." dex,")
end
...
doShowTextDialog(cid, 2382, table.concat(stt))
end
...
function doConvertStoneIdToString(stoneID)
    ...
    [14434] = "Cell Stone",
    [13234] = "Shiny Stone",
    [boostStone] = "Boost Stone",  --alterado v1.9[13198] = "Mega Stone"-[13234] = "Shiny Stone",
    }
    if t[stoneID] then
    return t[stoneID]
    else
