local pos_room = {x=1227,y=2377,z=8} 
local radius = 11 
local Premio = {x=1227, y=2364, z=8}
...
function onUse(cid,item,pos) 
   ...
   doPlayerSendTextMessage(cid, 26, "Derrote todos o Boss Togekiss para poder passar para seu premio ou reculha os pokemon para ball")
   return true 
end