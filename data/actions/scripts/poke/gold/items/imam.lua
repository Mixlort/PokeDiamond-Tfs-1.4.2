...
storage = 46546514 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 12198 -- Id do item ira ganhar.
nomeitem = "Imam" -- Nome do item
