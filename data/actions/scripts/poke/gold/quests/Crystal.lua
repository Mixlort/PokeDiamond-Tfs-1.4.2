...
doBroadcastMessage("o "..getCreatureName(cid).." esta tentando fazer a quest Crystal stone ilegalmente")
return true
end
storage = 20112015 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
