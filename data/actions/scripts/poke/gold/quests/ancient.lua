...
doBroadcastMessage("o "..getCreatureName(cid).." esta tentando fazer a quest Ancient Amulet ilegalmente")
return true
end
storage = 99846515 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 2142 -- Id do item ira ganhar.
...
doPlayerSendTextMessage(cid,22,"Você encontrou o PRIMEIRO amuleto que um dia pertenceu aos sábios. Falta pouco para desvendar o MISTÉRIO! 1/2") -- Mensagem que aparecera quando ganhar o item.
