...
doBroadcastMessage("o "..getCreatureName(cid).." esta tentando fazer a quest Hook ilegalmente")
return true
end
storage = 46546513 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 6097 -- Id do item ira ganhar.
nomeitem = "Hook" -- Nome do item
...
doPlayerSendTextMessage(cid,22,"Voce achou o "..nomeitem.." escondido.") -- Mensagem que aparecera quando ganhar o item.
