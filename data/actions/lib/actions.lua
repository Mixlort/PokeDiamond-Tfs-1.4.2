...
function onUsePick(player, item, fromPosition, target, toPosition, isHotkey)
	if target.itemid == 11227 then -- shiny stone refining
		...
		if chance == 1 then
			player:addItem(ITEM_TEN_THOUSAND_DOLLAR_NOTE) -- 1% chance of getting crystal coin
		elseif chance <= 6 then
			player:addItem(ITEM_DOLLAR_NOTE) -- 5% chance of getting dollar
		elseif chance <= 51 then
			player:addItem(ITEM_HUNDRED_DOLLAR_NOTE) -- 45% chance of getting platinum coin
		else
