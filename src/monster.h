...
{
	public:
        static Monster* createMonster(const std::string& name, uint16_t bst);
		static int32_t despawnRange;
		static int32_t despawnRadius;

        explicit Monster(MonsterType* mType, uint16_t bst);
		~Monster();
        ...
        // int32_t levelToUse() const {
        //     return mType->info.levelToUse;
        // }
