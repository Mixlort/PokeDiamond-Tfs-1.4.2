...
class LuaScriptInterface
{
	...
	private:
        ...
        static int luaSetCreatureIcon(lua_State* L);
        static int luaGetCreatureIcon(lua_State* L);
        ...
        static int luaCreatureGetStorageStringValue(lua_State* L);
        static int luaCreatureSetStorageStringValue(lua_State* L); 
        ...
        //mixlort
        // static int luaMonsterTypelevelToUse(lua_State* L);
		...
		static int luaMonsterTypeHungerDelay(lua_State* L);
