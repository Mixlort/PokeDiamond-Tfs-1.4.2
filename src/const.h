...
enum item_t : uint16_t {
	...
	ITEM_MAGICWALL_NOPVP = 14080,

	ITEM_WILDGROWTH = 1499,
	ITEM_WILDGROWTH_PERSISTENT = 2721,
	ITEM_WILDGROWTH_SAFE = 11099,
	ITEM_WILDGROWTH_NOPVP = 14081,

	ITEM_BAG = 1987,
    ITEM_BACKPACK = 1988,
	ITEM_SHOPPING_BAG = 14082,

	ITEM_COIN = 3956,
	ITEM_DOLLAR_NOTE = 2148,
	ITEM_HUNDRED_DOLLAR_NOTE = 2152,
	ITEM_TEN_THOUSAND_DOLLAR_NOTE = 2160,
	ITEM_MILLION_DOLLAR_NOTE = 2161, 
	ITEM_STORE_COIN = 2145, // in-game store currency

	ITEM_DEPOT = 2594,
	ITEM_LOCKER1 = 2589,
	ITEM_INBOX = 14083,
	ITEM_MARKET = 14084,
    ITEM_STORE_INBOX = 14085,
    ITEM_DEPOT_BOX_I = 14086,
    ITEM_DEPOT_BOX_II = 14087,
    ITEM_DEPOT_BOX_III = 14088,
    ITEM_DEPOT_BOX_IV = 14089,
    ITEM_DEPOT_BOX_V = 14090,
    ITEM_DEPOT_BOX_VI = 14091,
    ITEM_DEPOT_BOX_VII = 14092,
    ITEM_DEPOT_BOX_VIII = 14093,
    ITEM_DEPOT_BOX_IX = 14094,
    ITEM_DEPOT_BOX_X = 14095,
    ITEM_DEPOT_BOX_XI = 14096,
    ITEM_DEPOT_BOX_XII = 14097,
    ITEM_DEPOT_BOX_XIII = 14098,
    ITEM_DEPOT_BOX_XIV = 14099,
    ITEM_DEPOT_BOX_XV = 14100,
    ITEM_DEPOT_BOX_XVI = 14101,
    ITEM_DEPOT_BOX_XVII = 14102,
